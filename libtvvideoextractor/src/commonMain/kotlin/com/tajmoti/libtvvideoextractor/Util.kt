 ...
 */
interface WebDriverPageSourceLoader {
    suspend fun load(url: String, urlBlocker: UrlBlocker): Result<String>
}
 ...
 * A WebDriver is used to load the full page, useless URLs are blocked with urlBlocker.
 */
interface WebDriverPageSourceLoaderWithCustomJs {
    suspend fun load (url: String, urlBlocker: UrlBlocker, submitTriggerJsGenerator: (String) -> String): Result<String>
}
