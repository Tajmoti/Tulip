...
class EpisodesFragment : BaseFragment<FragmentEpisodesBinding>(FragmentEpisodesBinding::inflate) {
    ...
    private fun onStreamClicked(episode: Episode) {
        slideToBottomDismiss()
        playerViewModel.changeStreamable(episode.key)
    }

    private fun onEpisodeDetailsClicked(episode: Episode) {
    ...
    private fun preselectPlayingSeason(seasons: List<Season>) {
    ...
    private fun onSeasonChanged(season: SeasonWithEpisodes) {
